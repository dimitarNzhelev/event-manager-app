        ...
        <div className="container mx-auto px-6 py-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <AlertListPrometheus onSelectAlert={setSelectedAlert} forSilence={false} refresh={refresh} />
              </div>
              <div>
                <h2 className="text-xl font-semibold mb-4">Alert Details</h2>
                {selectedAlert ? (
                  <AlertDetailsPrometheus alert={selectedAlert} silenced={false} setRefresh={setRefresh} refresh={refresh}/>
                ) : (
